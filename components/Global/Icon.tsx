...
const Icon = ({name, className, color}: IconCompProp) => {
    ...
    if(name==='addread') return (
        <ReadlistAdd className={className} color={color}/>
    )
...
function ReadlistAdd({className, color}:{ className?: string, color?: string }) {
  return (
    <svg
      className={" w-3 text-white " + className}
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 18"
    >
      <path
        fill={ color || "currentColor"}
        d="M13.2 4.987h-12c-.66 0-1.2.561-1.2 1.247C0 6.919.54 7.48 1.2 7.48h12c.66 0 1.2-.562 1.2-1.247 0-.686-.54-1.247-1.2-1.247zM13.2 0h-12C.54 0 0 .561 0 1.247c0 .685.54 1.247 1.2 1.247h12c.66 0 1.2-.562 1.2-1.247C14.4.56 13.86 0 13.2 0zm6 9.974v-3.74c0-.686-.54-1.247-1.2-1.247-.66 0-1.2.561-1.2 1.247v3.74h-3.6c-.66 0-1.2.561-1.2 1.247 0 .685.54 1.246 1.2 1.246h3.6v3.74c0 .686.54 1.247 1.2 1.247.66 0 1.2-.56 1.2-1.246v-3.74h3.6c.66 0 1.2-.562 1.2-1.247 0-.686-.54-1.247-1.2-1.247h-3.6zm-18 2.493h7.2c.66 0 1.2-.56 1.2-1.246 0-.686-.54-1.247-1.2-1.247H1.2c-.66 0-1.2.561-1.2 1.247 0 .685.54 1.246 1.2 1.246z"
      ></path>
    </svg>
  );
}
...
return (
    <svg
    className={" text-nifty-gray-1 w-5 " + className}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 22 22"
    >
