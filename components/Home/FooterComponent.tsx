    ...
    <div className='bg-[#1a1a1a] w-screen px-20 pt-20 max-md:px-5 max-md:pt-10 text-white'>
        ...
        <div className='grid grid-cols-3 max-md:grid-cols-2 max-md:text-sm max-md:mt-5 mt-10'>
            <ul className='flex flex-col gap-2'>
                <li className='max-md:hidden'><a className='flex items-center justify-center gap-2 w-fit' href="https://mail.google.com/mail/?view=cm&fs=1&to=risavdeb03@gmail.com" target='_blank'><IoMdMail/>Email</a></li>
                <li className='md:hidden'><a className='flex items-center justify-center gap-2 w-fit' href="https://mail.google.com/mail/?view=cm&fs=1&to=risavdeb03@gmail.com" target='_blank'><IoMdMail/>Email</a></li>
                {/* <li>Instagram</li> */}
